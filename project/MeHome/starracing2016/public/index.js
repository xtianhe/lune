...
function e(t, n, o) {
    ...
    8: [function(e, t, n) {
        ...
        function(r, i) {
            ...
            w.init = function(t) {
                ...
                if ("WECHAT" === e.pf) {
                    o(t);
                    t.jsApiConf.jsApiList = ["onMenuShareTimeline", "onMenuShareAppMessage", "onMenuShareQQ"];
                    n.config(t.jsApiConf);
                    a(t)
                }
            }, w.share = function(t) {
                switch (o(t), e.pf) {
    ...
    31: [function(e, t, n) {
        ...
        n.startGameAnimation = function() {
            ...
            //点击就ta后传送来的L
            $(".game-status").show();
            //使用了选择的明星资料L----starId明星ID
            $(".star-comment-wrap .avatar").style("background", "url(./starracing2016/public/c/images/head.png) 0px 0px / cover no-repeat");
            i(e);
            d = 0;
            p = 1;
        };
    ...
    37: [function(e, t, n) {
        ...
        var mt = null;
        n.render = function(e) {
            if (B.getResource(CONF.RESOURCE.GAME[CONF.RESOURCE.GAME.length - 1])) {
               r(e);
            }else{
                nt.playBgm();
                mt = +new Date;
                H.showLoading();
                window.scrollTo(0, 0);
                B.loadEssentialResource(CONF.RESOURCE.GAME, function() {
                    var t = +new Date;
                    if (t - mt > CONF.LEAST_WAITING_TIME) {
                        H.hideLoading();
                        r(e);
                    }else{
                        setTimeout(function() {
    ...
    40: [function(e, t, n) {
        ...
        function i() {
            ...
            c(".game-desc").delay(200).addClass("common-in-1").delay(2e3).exec(function() {
                c(".game-desc").addClass("common-out-1").delay(150).exec(function() {
        ...
        function r(e) {
            ...
            function() {
                for (var t = function T() {
                    ...
                    var p = i('<img src="./starracing2016/public/c/page-result/img/coin_rain.png">').style("top", 100 * Math.random() + "%").style("left", 90 * Math.random() + "%");
                    n.append(p)
                }
    ...
    42: [function(e, t, n) {
        ...
        function i(L) {
            p.loadEssentialResource(CONF.RESOURCE.RESULT.concat(CONF.RESOURCE.GAME_MUSIC), function() {
                //如果是用户自己第一次登陆，直接跳到游戏，否则跳转到登陆页面
                if (L.isown && L.times == 0 && L.isfirst) {
                    L.isfirst = false;
                    e("../page-game").init && e("../page-game").init(L);
                    e("../page-game").render && e("../page-game").render(L)
                    return;
                }
                n.renderGameStatus(L);
                // c.render(e.records);
        ...
        function resettingFirst(e, point, qian, plane, tpoint, tqian){
            l.default(e);
            $(point).text(tpoint);
            $(qian).text(tqian);
            $(plane).show();
            var str = '';
            if (e.times>0) {
                str = '<li><div class="avatar"> <img src="'+ e.img
                    + '"></div><p class="time">获得<span class="red">'+ e.coin / 10
                    + '</span>元</p><p>'+ e.name +'</p></li>';
            }
            for (var i = e.help.length - 1; i >= 0; i--) {
                var h = e.help[i];
                // str += '<li><div class="avatar"> <img src="'+ h.image +'"></div>'
                //     + '<p class="name">'+ h.name +'</p>'
                //     + '<p class="time">'+ new Date(h.time).Format('MM-DD HH-mm') +'</p>'
                //     + '<p>获得<span class="red">'+ (h.num/10) +'</span>元</p></li>';
                str += '<li><div class="avatar"> <img src="'+ h.image
                    + '"></div><p class="time">获得<span class="red">'+ (h.num / 10)
                    + '</span>元</p><p>'+ h.name +'</p></li>';
            }
            jQuery("#cmp-friends ul").html(str);
            a(e);
        }

        function resettingCMP(e, point, qian, plane){
            jQuery.ajax({
                url: "http://api.mehome.tv/game/info?sign="+SIGN,
                dataType: 'jsonp',
                jsonp:'callback',
                success: function(res){
                    ...
                    var data = res.data;
                    e.coin = data.num;
                    e.totalPoint = data.total;
                    e.qian = data.total/10;
                    //金币雨
                    l.default(e);
                    if (e.isown) {
                        $(point).text(e.coin/10);
                        $(qian).text(e.qian);
                    }else{
                        $(point).text(e.coin);
                        $(qian).text(e.coin/10);
        ...
        n.renderGameStatus = function(e) {
            ...
            if (d(".wrap-game-status").hide(), e.blacklist){
                ...
                if (e.isfirst) {
                    e.isfirst = false;
                    tpoint = e.isown ? e.coinNum/10 : e.totalPoint;
                    tqian = e.isown ? e.qian : e.qian;
                    if (e.isown) {
                        console.log("myself first");
                        if (e.isend) {
                            point = "#wrap-finished .total-point";
                            plane = "#wrap-finished";
                        }else{
                            point = "#wrap-unfinished .total-point";
                            qian = "#wrap-unfinished .total-qian";
                            plane = "#wrap-unfinished";
                        }
                    }else{
                        //是否创建游戏
                        ...
                        if (e.hasGame) {
                            if (e.isend) {
                                point = "#wrap-friend-created-finished .total-point";
                                qian = "#wrap-friend-created-finished .total-qian";
                                plane = "#wrap-friend-created-finished";
                            }else{
                                point = "#wrap-friend-created .total-point";
                                qian = "#wrap-friend-created .total-qian";
                                plane = "#wrap-friend-created";
                            }
                        }else{
                            if (e.isend) {
                                point = "#wrap-friend-finished .total-point";
                                qian = "#wrap-friend-finished .total-qian";
                                plane = "#wrap-friend-finished";
                            }else{
                                point = "#wrap-friend .total-point";
                                qian = "#wrap-friend .total-qian";
                                plane = "#wrap-friend";
                            }
                        }
                    }
                    resettingFirst(e, point, qian, plane, tpoint, tqian);
                }else{
                    jQuery.ajax({
                        url: "http://api.mehome.tv/game/sub",
                        dataType: 'jsonp',
                        data: {
                            sign: SIGN,
                            coin: e.coinNum
                        ...
                        success: function(res){
                            ...
                            resettingCMP(e, point, qian, plane);
                        },
                        error: function(res){
                            console.log(res)
                        }
    ...
    45: [function(e, t, n) {
        ...
        function r() {
            M.register("inited", function() {
                ...
                jQuery.ajax({
                    ...
                    success: function(res){
                        ...
                        var data = res.data;
                        L.coinNum = L.coin = data.num;
                        L.totalPoint = data.total;
                        L.qian = data.total/10;
                        L.isown = data.isown;
                        L.isend = data.isend;
                        L.times = data.times;
                        L.hasGame = data.isown ? data.times > 0 : data.self.sign != '';
                        L.help = data.help;
                        L.isHelp = data.isown ? data.times > 0 : data.self.state == 1;
                        L.name = data.isown ? data.name : data.self.name;
                        L.img = data.isown ? data.image : data.self.image;
                        o("result");
                    },
                    error: function(res){
                        console.log(res)
            ...
            M.register("submitStar", function() {
                //点击集金币按钮后进入
                E("#page-index").hide();
                k.hide();
                U.game.render(L);
            ...
            M.register("eatCoin", function(e) {
                ...
                ++L.coinCombo;
                L.downGear = !1;
                if (L.coinCombo === CONF.UPDATE_GEAR_COMBO) {
                    L.upGear = !0, L.coinCombo = 0
                }else{
                    L.upGear = !1
                }
            ...
            M.register("collisionTrafficCone", function(e) {
                if (CONF.TOTALL_DISTANCE == 0) {return;}
                CONF.TOTALL_DISTANCE = 0;
                isCollide = true;
            });
            ...
            M.register("distanceCompleted", function() {
                ...
                if (L.coinNum > CONF.MIN_COIN_NUM) {
                    if (isCollide) {
                        console.log("碰瓷");
                        $("body").append(pengci)
                        $(".btn-pengci-know").on("touchstart", function(e) {
                            e.stopPropagation(), e.preventDefault();
                            try {
                                $("body").remove(pengci)
                            } catch (e) {}
            ...
            M.register("help", function() {
                k.hide();
                CONF.TOTALL_DISTANCE = CONF.DISTANCE;
                isCollide = false;
                o("game")
            });
            M.register("wantPlay", function() {
                console.log("创建游戏");
                location.href = "http://api.mehome.tv/game/check";
            });
            ...
            //重置游戏获取的金币以及流程。
            M.register("retry", y);
            M.register("goRulePage", function() {
        ...
        function f() {
            O.init({
                ...
                desc: MSG.SHARE.DESC.replace("XXX", L.totalPoint),
                imgUrl: MSG.SHARE.IMG_URL,
                link: location.href
            })
        }
    ...
    49: [function(e, t) {
        //再玩一次
        t.exports = '<section class="mask-game-fail mask-game-pengci">\n    <div class="img-fail"></div>\n    <p>不好意思，你遇到了碰瓷党</p><p>火速叫小伙伴帮你众筹拿走行车记录仪</p><br>\n   <div class="btn-pengci-know button"></div>\n</section>'
    }, {}],
    50: [function(e) {
        "use strict";
