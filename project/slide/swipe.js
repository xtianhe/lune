function Swipe(t, n) {
    ...
    function e() {
        w = x.children, p = w.length, w.length < 2 && (n.continuous = !1), h.transitions && n.continuous && w.length < 3, E = new Array(w.length), m = t.getBoundingClientRect().width || t.offsetWidth, x.style.width = w.length * m + "px";
        for (var e = w.length; e--;) {
            var i = w[e];
            i.style.width = m + "px", i.setAttribute("data-index", e), h.transitions && (i.style.left = e * -m + "px", a(e, b > e ? -m : e > b ? m : 0, 0))
        }
        n.continuous && h.transitions && (a(s(b - 1), -m, 0), a(s(b + 1), m, 0)), h.transitions || (x.style.left = b * -m + "px"), t.style.visibility = "visible"
    }
    ...
    function r(t, e) {
        if (b != t) {
            if (h.transitions) {
                ...
                if (n.continuous) {
                    var o = i;
                    i = -E[s(t)] / m, i !== o && (t = -i * w.length + t)
                }
                for (var r = Math.abs(b - t) - 1; r--;) a(s((t > b ? t : b) - r - 1), m * i, 0);
                t = s(t), a(b, m * i, e || g), a(t, 0, e || g), n.continuous && a(s(t - i), -(m * i), 0)
            } else t = s(t), c(b * -m, t * -m, e || g);
            b = t, f(n.callback && n.callback(b, w[b]))
        }
    }
                ...
                move: function(t) {
                    if (!(t.touches.length > 1 || t.scale && 1 !== t.scale)) {
                        ...
                        D = {
                            x: e.pageX - k.x,
                            y: e.pageY - k.y
                        }, "undefined" == typeof y && (y = !!(y || Math.abs(D.x) < Math.abs(D.y))), y || (t.preventDefault(), l(), n.continuous ? (u(s(b - 1), D.x + E[s(b - 1)], 0), u(b, D.x + E[b], 0), u(s(b + 1), D.x + E[s(b + 1)], 0)) : (D.x = D.x / (!b && D.x > 0 || b == w.length - 1 && D.x < 0 ? Math.abs(D.x) / m + 1 : 1), u(b - 1, D.x + E[b - 1], 0), u(b, D.x + E[b], 0), u(b + 1, D.x + E[b + 1], 0)))
                    }
                },
                end: function() {
                    ...
                    n.continuous && (i = !1);
                    var o = D.x < 0;
                    y || (e && !i ? (o ? (n.continuous ? (a(s(b - 1), -m, 0), a(s(b + 2), m, 0)) : a(b - 1, -m, 0), a(b, E[b] - m, g), a(s(b + 1), E[s(b + 1)] - m, g), b = s(b + 1)) : (n.continuous ? (a(s(b + 1), m, 0), a(s(b - 2), -m, 0)) : a(b + 1, m, 0), a(b, E[b] + m, g), a(s(b - 1), E[s(b - 1)] + m, g), b = s(b - 1)), n.callback && n.callback(b, w[b])) : n.continuous ? (a(s(b - 1), -m, g), a(b, 0, g), a(s(b + 1), m, g)) : (a(b - 1, -m, g), a(b, 0, g), a(b + 1, m, g))), x.removeEventListener("touchmove", M, !1), x.removeEventListener("touchend", M, !1)
                },
        ...
        return e(), L && d(), h.addEventListener ? (h.touch && x.addEventListener("touchstart", M, !1), h.transitions && (x.addEventListener("webkitTransitionEnd", M, !1), x.addEventListener("msTransitionEnd", M, !1), x.addEventListener("oTransitionEnd", M, !1), x.addEventListener("otransitionend", M, !1), x.addEventListener("transitionend", M, !1)), window.addEventListener("resize", M, !1)) : window.onresize = function() {
            ...
            kill: function() {
                ...
                for (var t = w.length; t--;) {
                    var n = w[t];
                    n.style.width = "", n.style.left = "", h.transitions && u(t, 0, 0)
                }
